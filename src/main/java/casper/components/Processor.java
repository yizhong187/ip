        ...
        switch (command) {
            ...
            case "mark", "unmark", "delete" -> {
                ...
                if (Objects.equals(command, "mark")) {
                    ...
                    Storage.editTaskInSavedTasks(CasperChat.FILE_PATH,
                    ...
                    Storage.editTaskInSavedTasks(CasperChat.FILE_PATH,
                            taskList.getTaskSaveString(taskIndex),
                            taskIndex + 1);
                    Ui.print("I have unmarked this task:\n" + taskList.getTaskString(taskIndex));
            ...
            case "todo", "deadline", "event" -> {
                ...
                Storage.addTaskToSavedTasks(CasperChat.FILE_PATH, taskList.getTaskSaveString(taskList.size() - 1));
                Ui.printAddedTaskMessage(taskList.getTaskString(taskList.size() - 1), taskList.size());
            }
